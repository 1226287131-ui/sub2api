export default {
    ...
    channels: {
      ...
      form: {
        ...
        hideCacheCreation: 'Bill cache creation as regular input',
        hideCacheCreationHint: 'For new requests, merge cache creation into regular input for local and downstream usage and billing. Cache reads are unchanged. Input totals that already include creation are not increased again. Historical records are unchanged.',
