...
type GatewayConfig struct {
	...
	// OpenAIStreamPrimingEnabled controls whether OpenAI HTTP streaming responses
	// start with a non-semantic SSE frame for prompt downstream first-byte timing.
	OpenAIStreamPrimingEnabled bool `mapstructure:"openai_stream_priming_enabled"`
...
func setDefaults() {
	...
	viper.SetDefault("gateway.openai_stream_priming_enabled", true)
